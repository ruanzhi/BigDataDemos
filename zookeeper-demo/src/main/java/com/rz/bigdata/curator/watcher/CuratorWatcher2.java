package com.rz.bigdata.curator.watcher;
...
public class CuratorWatcher2 {
     ...
     * zookeeper地址
     */
    static final String CONNECT_ADDR = "192.168.56.101:2181";
    /**
     * session超时时间
     */
            ...
            public void childEvent(CuratorFramework cf, PathChildrenCacheEvent event) throws Exception {
                switch (event.getType()) {
                    case CHILD_ADDED:
                        ...
                        System.out.println("CHILD_ADDED_DATA :" + new String(event.getData().getData()));
                        break;
                    case CHILD_UPDATED:
                        System.out.println("CHILD_UPDATED :" + event.getData().getPath());
                        System.out.println("CHILD_UPDATED_DATA :" + new String(event.getData().getData()));
                        break;
                    case CHILD_REMOVED:
                        System.out.println("CHILD_REMOVED :" + event.getData().getPath());
                        System.out.println("CHILD_REMOVED_DATA :" + new String(event.getData().getData()));
                        break;
                    default:
                        break;
                }
